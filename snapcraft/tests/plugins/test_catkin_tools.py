...
class CatkinToolsPluginTestCase(CatkinToolsPluginBaseTestCase):
    ...
    def test_schema(self):
        schema = catkin_tools.CatkinToolsPlugin.schema()
    ...
    def test_get_pull_properties(self):
        expected_pull_properties = ['rosdistro', 'catkin-packages',
                                    ...
                                    'underlay']
        CatkinToolsPlugin = catkin_tools.CatkinToolsPlugin
        resulting_pull_properties = CatkinToolsPlugin.get_pull_properties()
    ...
    def test_invalid_rosdistro(self):
        ...
        raised = self.assertRaises(
            RuntimeError,
            catkin_tools.CatkinToolsPlugin,
    ...
    @mock.patch.object(catkin_tools.CatkinToolsPlugin,
                       '_generate_snapcraft_setup_sh')
    ...
    @mock.patch('snapcraft.plugins.catkin.Compilers')
    @mock.patch.object(catkin.Compilers, 'cxxflags')
    @mock.patch.object(catkin_tools.CatkinToolsPlugin, 'run')
    @mock.patch.object(catkin_tools.CatkinToolsPlugin, 'run_output',
                       return_value='foo')
    def test_build_runs_in_bash(self, run_output_mock, run_mock, cxxflags_mock,
                                compilers_mock):
        plugin = catkin_tools.CatkinToolsPlugin('test-part', self.properties,
                                                self.project_options)
        os.makedirs(os.path.join(plugin.sourcedir, 'src'))
        compilers_mock.cxxflags = "flag"
    ...
    @mock.patch.object(catkin_tools.CatkinToolsPlugin, '_source_setup_sh',
    ...
    def test_prepare_build(self, use_python_mock, cxxflags_mock):
        plugin = catkin_tools.CatkinToolsPlugin('test-part', self.properties,
                                                self.project_options)
...
class PullTestCase(CatkinToolsPluginBaseTestCase):
...
class FinishBuildTestCase(CatkinToolsPluginBaseTestCase):
    ...
    def setUp(self):
        ...
        self.properties.underlay = self.underlay
        self.plugin = catkin_tools.CatkinToolsPlugin(
...
class RosdepTestCase(tests.TestCase):
    ...
    def setUp(self):
        ...
        self.rosdep = catkin.Rosdep('kinetic', 'package_path', 'rosdep_path',
...
class CatkinToolsFindTestCase(tests.TestCase):
    def setUp(self):
        super().setUp()
